        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <a class="dropdown-item" href="Anak">Spesialis Anak</a>
              <a class="dropdown-item" href="Anastesi">Spesialis Anastesi</a>
              <a class="dropdown-item" href="Umum">Umum</a>
              <a class="dropdown-item" href="JadwalDokter">Jadwal Praktek</a>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Visi</h1>
            <span class="color-text-a">
              <p align="justify">Menurunkan angka kesakitan dan kematian ibu dan anak melalui pelayanan medik prima</p>
            </span>
            <h1 class="title-single">Misi</h1>
            <span class="color-text-a">
              <p align="justify">1. Menurunkan angka kesakitan dan kematian ibu dan anak</p>
              <p align="justify">2.  Memberikan pelayanan kehamilan, persalinan secara profesional dan paripurna</p>
              <p align="justify">3.  Terwujudnya peningkatan kualitas kesehatan ibu dan anak</p>
              <p align="justify">4.  Mengoptimalkan tumbuh kembang anak</p>
              <p align="justify">5.  Meningkatkan sumberdaya dibidang pelayanan kesehatan ibu dan anak</p>
            </span>
          </div>
        </div>
